...
public class EditUserController {
    ...
    public String userEdit(HttpSession session, Model model) {
        ...
        userDTO.getCurrentDataUser(userRep);
    ...
    public String postUserEdit(@ModelAttribute UserDTO userDTO, User userRep, Model model) {
        PostStatus status = PostStatus.ERROR;
        try {
            userDTO.setCurrentDataUser(userRep);
